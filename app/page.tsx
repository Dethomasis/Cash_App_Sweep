  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-5">
      ...
      <div className="w-56 h-16 rounded-xl flex items-center justify-center mb-4 p-2">
        <Image src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202026-02-03%20at%208.40.38%E2%80%AFAM-7n8Uw5PoaVaes4eLe6tpL5l2mTcTU7.png" alt="Cash App" width={200} height={50} className="object-contain" />
      </div>
      ...
      <div className="w-full max-w-sm bg-gray-50 rounded-lg p-4 mb-3 border border-gray-100">
        ...
        <div className="space-y-2.5">
          <div className="flex items-start gap-2.5">
            <Check className="w-4 h-4 text-[#00D54B] mt-0.5 flex-shrink-0 text-[rgba(0,194,67,1)]" />
            <div>
              <p className="text-gray-900 text-sm font-bold">Complete 2-3 required deals</p>
              <p className="text-[#00D54B] text-sm font-semibold text-[rgba(0,194,67,1)]">Earn up to $750</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div>
              ...
              <p className="text-[#00D54B] text-sm font-semibold text-[rgba(0,194,67,1)]">For instant notification</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div>
              ...
              <p className="text-[#00D54B] text-sm font-semibold text-[rgba(0,194,67,1)]">Required</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-sm bg-gray-50 rounded-lg p-4 mb-4 border border-gray-100">
        ...
        <div className="space-y-2.5">
          <div>
            <p className="text-[#00D54B] text-sm font-bold text-[rgba(0,194,67,1)]">How long do the deals take?</p>
            <p className="text-gray-500 text-sm">Quick 10-20 minute completion time per deal</p>
          </div>

          <div>
            <p className="text-[#00D54B] text-sm font-bold text-[rgba(0,194,67,1)]">What are deals?</p>
      ...
      <a
        ...
        className="w-full max-w-sm bg-[#00D54B] hover:bg-[#00C044] text-white py-3.5 px-5 flex items-center justify-center gap-2 transition-colors font-bold text-sm rounded-lg bg-[rgba(0,194,67,1)]"
      >
        Start Now
